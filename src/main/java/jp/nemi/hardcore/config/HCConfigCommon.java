...
public class HCConfigCommon {
    ...
    //Entity
    public static ForgeConfigSpec.BooleanValue isEnhanceEnemyMob;
    public static ForgeConfigSpec.BooleanValue isEnhanceZombieMob;
    public static ForgeConfigSpec.BooleanValue isEnhanceSkeletonMob;
    public static ForgeConfigSpec.BooleanValue isEnhanceSpiderMob;
    public static ForgeConfigSpec.BooleanValue isEnhanceCreeperMob;
    public static ForgeConfigSpec.BooleanValue isEnhanceEndermanMob;
    ...
    static {
        ...
        isEnhanceEnemyMob = BUILDER .comment("\ntrueの場合、全ての敵MOBが強化されます(個別に設定可)。\nIf true, all enemy MOBs are enhanced (can be set individually).\nデフォルト: true\nDefault: true").define("isEnhanceEnemyMob", true);

        BUILDER.comment("Other");
        isDebugMode = BUILDER.comment("\n開発者用(※trueになっていたらfalseに設定してください。)\nFor developers(*If it is true, set it to false.)\nデフォルト: false\nDefault: false").define("isDebugMode", true);
